  ...
  return (
    <div className={cn("flex flex-col items-center justify-center h-full p-8 text-center", className)}>
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-heading font-bold text-foreground mb-2">Welcome to Syntra Chat</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl w-full mb-8">
        {samplePrompts.map((prompt, index) => {
          ...
          return (
            <Card
              key={index}
              className="p-4 bg-card border-border hover:bg-muted transition-colors cursor-pointer group"
